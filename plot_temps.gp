...
filename="temps_raw_data_current"
...
set output 'webpage/temp_plots/temps.svg'
...
# Set range
daysback=2
secondsago = strftime("%d-%m-%Y\t%H:%M:%S", time(0)-60*60*24*2 ) # Note: Time function returns UTC
...
set output 'webpage/temp_plots/temps_day_comparison.svg'
